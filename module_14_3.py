...
async def get_buying_list(message):
    products = [
        {"name": "Product1", "description": "Описание 1", "price": 100, "image": 'images/1.png'},
        {"name": "Product2", "description": "Описание 2", "price": 200, "image": 'images/2.png'},
        {"name": "Product3", "description": "Описание 3", "price": 300, "image": 'images/3.png'},
        {"name": "Product4", "description": "Описание 4", "price": 400, "image": 'images/4.png'},
    ]
    for product in products:
        with open(product["image"], 'rb') as img:
            await message.answer_photo(img, f'Название: {product["name"]} | Описание: {product["description"]} | Цена: {product["price"]}')
