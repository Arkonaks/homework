...
import asyncio
from crud_functions import initiate_db, get_all_products, add_users, is_included
...
button_6 = KeyboardButton(text='Регистрация')
...
kb_1.add(button_1, button_2, button_5, button_6)
...
async def set_username(message, state):
    if not is_included(message.text):
        ...
        await message.answer('Введите свое email:')
...
async def set_age(message, state):
    ...
    add_users(user_data['username'], user_data['email'], user_data['age'], 1000)
